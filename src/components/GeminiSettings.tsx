...
export function GeminiSettings({
    ...
    return (
        <SectionCard title="Gemini settings" subtitle="Enter your Gemini key and pick a model.">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2 md:col-span-2">
                    ...
                    <select
                        ...
                        onChange={(e) => setMediaResolution(e.target.value as 'low' | 'standard')}
                        disabled={locked}
                    >
                    ...
                    <p className={theme.helperText}>
                        Low cuts token usage for video summaries. Switch to standard if visual detail is missing.
                    </p>
                </div>
            </div>
